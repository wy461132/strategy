...
last update: 2023年3月9日 09:29:38
"""
...
class CandlestickItem(pg.GraphicsObject):
    ...
    def __init__(self, data):
        ...
        self.pictures = []
        self.bPen     = pg.mkPen(color=(0,176,26), width=w*2)
        self.bBrush   = pg.mkBrush((0,176,26))
        self.rPen     = pg.mkPen(color=(255,113,113), width=w*2)
        self.rBrush   = pg.mkBrush((255,113,113))
...
class KLineWidget(KeyWraper):
    ...
    def __init__(self,parent=None):
        ...
        # 所有K线上信号图
        self.allColorList = ['#FFFFFF','#A865F3','#368FFF','#FFEA5A','#B6FF1A','#F411E7']
        self.allColor = deque(self.allColorList)
        self.sigData  = {}
        self.sigColor = {}
        self.sigPlots = {}

        # 所副图上信号图
        self.allSubColorList = ['#FFFFFF', '#FFEA5A','#A865F3', '#F411E7']
        self.allSubColor = deque(self.allSubColorList)
        self.subSigData  = {}
        self.subSigColor = {}
        self.subSigPlots = {}
    ...
    def initUi(self):
        ...
        self.KLtitle = self.lay_KL.addLabel('PythonGo')
    ...
    def showSig(self,datas,main=True,clear=False):
        ...
        if main:
            ...
            for sig in datas:
                ...
                self.subSigPlots[sig].setData(np.append(datas[sig],0), pen=self.subSigColor[sig], name=sig)
    ...
    def plotMark(self):
        ...
        for i in range(len(self.listSig)):
            ...
            # 买信号
                ...
                arrow = pg.ArrowItem(pos=(i, self.datas[i]['low']), angle=90, brush=(168, 101, 243))
            # 卖信号
            elif self.listSig[i] < 0:
                arrow = pg.ArrowItem(pos=(i, self.datas[i]['high']), angle=-90, brush=(255, 234, 90))
